...
// CODE HERE
const totalPopulation = populations.reduce((accumulator, currentVal) => {
...
//const sumPurchases = purchases.filter(element => element.owner === "Bob").reduce((total, curr) => total + curr.price);

//console.log(sumPurchases);


const bobSledTotal = purchases.reduce((acc,currVal) => {
  if(currVal.owner === "Bob"){
    acc += currVal.price;
  }
  return acc;
}, 0);

console.log(bobSledTotal);