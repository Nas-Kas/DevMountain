...
const empOne = new Employee("John", "Monday, Tuesday, Wednesday mornings");
empOne.getSchedule();
...
let empThree = new Manager("Jon Wick", "midnight shift", ["Jerry"]);
